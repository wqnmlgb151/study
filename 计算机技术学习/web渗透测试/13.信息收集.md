...
或者在文件根目录（跟oneforall.py在同一目录）创建.txt文件放入多个域名
...
君子协议：告诉网站爬虫不允许爬该目录		文件robots.txt
...
- [02.web运行原理与操作系统](02.web运行原理与操作系统.md) —— 域名/IP/子域等概念基础
- [08.Kali](08.Kali.md) —— 信息收集工具大多在 Kali 上运行  
