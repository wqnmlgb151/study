[15.PHP基础](15.PHP基础.md)[16.前后端交互](16.前后端交互.md)
...
//登录文件
    ...
    //生成随机值  随机唯一即可
    $token = bin2hex(random_bytes(16));//生成16字节（128位）的安全随机数据，并转换为32位十六进制字符串
    //绑定
...
- [12.数据传输与加密算法](12.数据传输与加密算法.md) —— 密码哈希/加密存储
- [23.XSS利用](23.XSS利用.md) —— XSS 偷 Cookie 攻击会话
